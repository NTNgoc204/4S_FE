    ...
    <>
      <main className="mx-auto w-[min(1320px,95vw)] pb-16 md:pt-8">
        <section className="text-center">
          ...
          <p className="mt-4 text-[1.14rem] text-slate-300 md:text-[1.4rem]">
        ...
        <section className="mx-auto mt-12 grid max-w-[800px] grid-cols-1 gap-6 md:grid-cols-2">
          <article className="relative flex h-full flex-col items-center rounded-[18px] border border-[#66789c]/34 bg-gradient-to-b from-[#263f5f]/95 to-[#18314c]/98 p-7 text-center shadow-[0_16px_35px_rgba(236,199,65,0.07)] md:p-8">
            ...
            <h3 className="mt-6 font-['Sora'] text-[2.05rem] tracking-[-0.03em]">
              {t("consultation:quiz.title")}
            </h3>
            <p className="mt-3 text-[1.08rem] text-slate-300">
              {t("consultation:quiz.description")}
            </p>

            <div className="mt-6 flex flex-wrap justify-center gap-2.5">
              {[
                t("consultation:quiz.tag1"),
                t("consultation:quiz.tag2"),
                t("consultation:quiz.tag3"),
              ].map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-[#ecc741]/28 bg-[#ecc741]/12 px-3 py-1 text-sm text-[#ecc741]"
                >
                  {tag}
                </span>
              ))}
            ...
            <button
              className="mt-auto w-full rounded-2xl bg-gradient-to-br from-[#ffdd5d] to-[#e5bc23] px-6 py-3.5 text-xl font-semibold text-[#112542] transition hover:brightness-110"
              type="button"
          ...
          <article className="flex h-full flex-col items-center rounded-[18px] border border-[#1f7f7a]/38 bg-gradient-to-b from-[#223a57]/95 to-[#172d47]/98 p-7 text-center shadow-[0_16px_35px_rgba(15,226,168,0.08)] md:p-8">
            ...
            <p className="mt-3 text-[1.08rem] text-slate-300">
              {t("consultation:chat.description")}
            </p>

            <div className="my-6 flex flex-wrap justify-center gap-2.5">
              {[
                t("consultation:chat.tag1"),
                t("consultation:chat.tag2"),
                t("consultation:chat.tag3"),
              ].map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-[#18c7a5]/35 bg-[#18c7a5]/14 px-3 py-1 text-sm text-[#0fe2a8]"
                >
                  {tag}
                </span>
              ))}
