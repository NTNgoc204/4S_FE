...
function CheckoutPage() {
  ...
  // Redux state
  const { user, plan: currentUserPlan } = useSelector((state) => state.auth);
  const { plans, paymentInfo, createPaymentLoading, createPaymentError } = useSelector((state) => state.plan);
  ...
  // UI mappings
  const planDisplayName = selectedPlan?.name === "PRO" ? "Pro Pack" : selectedPlan?.name === "EDU" ? "Edu Pack" : selectedPlan?.name || "...";
          ...
          <div>
            ...
            <div className="mb-6 rounded-2xl border border-white/5 bg-white/5 p-5">
              ...
              <div className="space-y-2.5 text-sm text-slate-200">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-slate-200">{user?.username || user?.email?.split('@')[0]}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="mb-8 rounded-2xl border border-white/5 bg-white/5 p-5">
              ...
              <div className="space-y-2.5 text-sm text-slate-200">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-[#ecc741]">{planDisplayName}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={createPaymentLoading || !selectedPlan}
                className="flex-1 rounded-xl bg-gradient-to-br from-[#ffdd5d] to-[#e5bc23] px-5 py-3 font-semibold text-[#112542] hover:brightness-110 disabled:opacity-50 transition shadow-lg"
                type="button"
              >
