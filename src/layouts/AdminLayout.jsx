...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    to: "/admin/feedbacks",
    icon: (
      <svg className="h-4 w-4 shrink-0 text-cyan-500 group-hover:scale-110 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
